            ...
            <div class="w-full md:w-3/4 h-auto bg-white pt-10 md:pt-20 md:pl-[15px] md:pr-[45px] pb-[50px]">
                <div class="md:flex">
                    <div class="w-full md:w-[40%] bg-white h-auto md:px-3">
                        <div class="flex items-center justify-center rounded-2xl border overflow-hidden">
                            <div class="slider-show" id="product-image">
                                <img src="./img/Products/<?php echo $_GET["imageProduct"]; ?>" alt="product">
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-[60%] bg-white h-auto md:px-3 mt-5 md:mt-0">
                        <div class="md:px-[30px]">
                            ...
                            <h1 id="product-name" class="mt-5 text-[#253d4e] text-2xl md:text-[38px] font-semibold"><?php echo $_GET["nameProduct"]; ?></h1>
                            ...
                            <div>
                                <span id="price_old" class="text-lg text-green-300 line-through"><?php echo $_GET["priceProduct"]; ?></span>
                ...
                <div class="md:px-[50px] md:py-10 md:border rounded-2xl mt-10">
                    ...
                    <div id="tab1" class="tab-content active text-[#7e7e7e] md:p-[10px] mt-5">
                        ...
                        <div class="text-[#253d4e] text-2xl font-semibold"><h3>Packaging & Delivery</h3></div>
                        ...
                        <div class="mb-5 text-[#253d4e] text-2xl font-semibold"><h3>Suggested Use</h3></div>
                        <div class="flex flex-col gap-y-5">
                            <a href="#">Refrigeration not necessary.</a>
                            <a href="#">Stir before serving</a>
                        </div>
                        <div class="text-[#253d4e] text-2xl font-semibold mt-10 mb-5"><h3>Other Ingredients</h3></div>
                        <div class="flex flex-col gap-y-5">
                        ...
                        <div class="text-[#253d4e] text-2xl font-semibold mt-10 mb-5"><h3>Warnings</h3></div>
